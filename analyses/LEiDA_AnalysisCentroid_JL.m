function LEiDA_AnalysisCentroid_JL(param)
...
Centroid = param.cluster.Centroid;
...
Vc_dir = fullfile(leida_res, ['K' num2str(SelectK) 'C' num2str(Centroid) '/']);  % changed by JL to make it more general and not require specification of '/'

if ~exist(Vc_dir, 'dir')  % changed by JL to make it more general and not require specification of '/'
    mkdir(Vc_dir);  % changed by JL to make it more general and not require specification of '/'
end

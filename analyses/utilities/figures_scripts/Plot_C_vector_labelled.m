function Plot_C_vector_labelled(data_dir,save_dir,selectedK,centroid,parcellation)
%
...
disp(' ');
disp(['Plotting the vector format with labels for the PL state ' num2str(centroid) ':'])

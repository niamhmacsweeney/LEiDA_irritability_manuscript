...
%cd(K_dir);% changed by JL to make it more general
...
% Load required data:
if isfile(fullfile(K_dir,file_V1_VoxelSpace))
    load(fullfile(K_dir,file_V1_VoxelSpace), 'mean_V1', 'ind_voxels', 'MNI10mm_Mask');
end

...
n_areas = parcellation.n_areas; % size(V,1); % changed by JL
...
atlas_struct = load('ParcelsMNI2mm',parcellation.name); % added by JL/LK
Volume =  atlas_struct.(parcellation.name).volume; % added by JL/LK
...
% % added by JL%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
labels = atlas_struct.(parcellation.name).labels; % added by JL

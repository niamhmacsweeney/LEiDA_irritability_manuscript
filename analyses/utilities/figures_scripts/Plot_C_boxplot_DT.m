function Plot_C_boxplot_DT(data_dir,save_dir,selectedK,centroid,parcellation)
%
...
if isfile(fullfile(data_dir, file_LT))
    load(fullfile(data_dir, file_LT), 'cond', 'LT', 'LT_pval2sided', 'Index_Conditions'); % changed by JL to make it more general
end

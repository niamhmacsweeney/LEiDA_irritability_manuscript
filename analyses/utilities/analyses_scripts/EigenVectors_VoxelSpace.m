...
% Load required data:
if isfile(fullfile(leida_dir, file_cluster))  % CHANGED BY JL to make it more general
...
save(fullfile(K_dir,  'V1_VoxelSpace'), 'mean_V1', 'ind_voxels', 'MNI10mm_Mask'); % CHANGED BY JL to make it more general
...
if pair == 0
    save(fullfile(data_dir, save_file),'P','P_pval','P_pval2sided', 'effectsize', 'levene_pval',...,
                              'cond','rangeK','file_cluster','file_V1','Index_Conditions', 'pair') % 'pair' added J/L
else
    save(fullfile(data_dir, save_file),'P','P_pval','P_pval2sided', 'effectsize',...,
                              'cond','rangeK','file_cluster','file_V1','Index_Conditions', 'pair') % 'pair' added J/L
end

...
load(fullfile(data_dir, file_V1), 'V1_all'); % changed by JL to make it more general
...
save(fullfile(data_dir, save_file), 'Kmeans_results', 'rangeK') % changed by JL to make it more general

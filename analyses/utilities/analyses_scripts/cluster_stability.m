...
% COMMENTED OUT BECAUSE CLUSTER RESULTS ARE NOT USED - INDEED
% K_mean_results is being newly defined with the partitioned results - JL
...
save(fullfile(save_dir, save_file),'ConfMat_fold','acc','VI_fold','rand_fold','Kmeans_results','cv'); % CHANGED BY JL TO MAKE IT MORE GENERAL

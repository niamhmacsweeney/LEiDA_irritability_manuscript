...
if isfile(fullfile(data_dir, file_V1)) % CHANGED BY JL TO MAKE IT MORE GENERAL
    load(fullfile(data_dir, file_V1), 'Time_sessions', 'Data_info', 'idx_data'); % CHANGED BY JL TO MAKE IT MORE GENERAL
end
...
if pair == 0
    save(fullfile(data_dir, save_file),'LT','LT_pval','LT_pval2sided', 'effectsize', 'levene_pval',..., % CHANGED BY JL TO MAKE IT MORE GENERAL
                              'cond','rangeK','file_cluster','file_V1','Index_Conditions')
else
    save(fullfile(data_dir, save_file),'LT','LT_pval','LT_pval2sided', 'effectsize',..., % CHANGED BY JL TO MAKE IT MORE GENERAL
                              'cond','rangeK','file_cluster','file_V1','Index_Conditions')
end
